...
SUSYObjDef_xAOD::SUSYObjDef_xAOD( const std::string& name )
  : asg::AsgMetadataTool( name ),
    ...
    m_EleFatJetDR(-999.),
    m_JetFatJetDR(-999.),
    m_doIsoSignal(true), //true
    m_doElIsoSignal(true), //true
    m_doPhIsoSignal(true), //true
    m_doMuIsoSignal(true), //true
    m_doIsoCloseByOR(true), //true
    m_metJetSelection(""),
    //
    m_currentSyst(),
    m_EG_corrModel(""),
    ...
    m_pmgSHnjetWeighterWZ("")
{
  ...
  //
  //declareProperty( "InDetTrackSelectionTool",  m_InDetTrackSelectionTool); // = TightPrimary);
  //JES Unc.
  ...
  m_InDetTrackSelectionTool.declarePropertyFor( this, "InDetTrackSelectionTool", "The InDetTrackSelectionTool" );
  ...
  //m_muonIsolationSFTool.declarePropertyFor( this, "", "The MuonIsolationSFTool" );
...
StatusCode SUSYObjDef_xAOD::readConfig()
{
  ...
  //configFromFile(m_InDetTrackSelectionTool, "InDetTrackSelectionTool", rEnv, "TightPrimary");
  //configFromFile(m_InDetTrackSelectionTool, "TightPrimary");
  ...
  configFromFile(m_InDetTrackSelection, "InDetTrackSelection", rEnv, "LoosePrimary");
  //
  ...
  //
  //configFromFile(m_useBtagging, "Btag.enable", rEnv, false);
...
CP::SystematicCode SUSYObjDef_xAOD::applySystematicVariation( const CP::SystematicSet& systConfig )
{
  ...
  /*if (!m_InDetTrackSelectionTool.empty()) {
    CP::SystematicCode ret = m_InDetTrackSelectionTool->applySystematicVariation(systConfig);
    if ( ret != CP::SystematicCode::Ok) {
      ATH_MSG_VERBOSE("Cannot configure InDetTrackSelectionTool for systematic var. " << systConfig.name() );
    } else {
      ATH_MSG_VERBOSE("Configured InDetTrackSelectionTool for systematic var. " << systConfig.name() );
    }
  }*/
