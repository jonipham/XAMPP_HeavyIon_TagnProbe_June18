...
//    StatusCode IsoOverlapRemoval(const xAOD::IParticleContainer *parts);
  ...
  protected:
    ...
    std::string m_InDetTrackSelection;
    ...
    //std::string m_InDetTrackSelectionTool;
    //std::string m_InDetTrackSelectionTool; //InDetTrackSelectionTool
    double m_muUncert;
    ...
    asg::AnaToolHandle<InDet::IInDetTrackSelectionTool> m_InDetTrackSelectionTool;
    //InDet::InDetTrackSelectionTool m_InDetTrackSelectionTool;
