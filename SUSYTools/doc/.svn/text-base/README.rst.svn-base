...
See the SUSY Background Forum Twiki:
https://twiki.cern.ch/twiki/bin/viewauth/AtlasProtected/BackgroundStudies

For the latest recommendations for 20.1, 20.7, and 21.0.
...
Where X is the Base release number that is recommended (if you literally use 'X' you will be setting up a nightly release, which may not be what you are after and is unlikely to work on the grid).  SUSYTools is now shipped with it, but you can also check a specific tag::
