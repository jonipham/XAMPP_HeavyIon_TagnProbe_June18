...
namespace XAMPP {
    ...
    StatusCode EventInfo::initialize() {
        ...
        ATH_CHECK(NewEventVariable<int>("PUvertices", m_RecoFlags));
        ...
        m_PUvertices = GetVariableStorage<int>("PUvertices");
    ...
    StatusCode EventInfo::FindPrimaryFertex() {
        ...
        ATH_CHECK(m_PUvertices->ConstStore(0));
        ...
        ATH_CHECK(m_PUvertices->ConstStore(pileup_vertices));
